 ...
 * When a modification is made to the wrapped collection, the onChange callback is invoked.
 */
public final class ChangeTrackingProxy {
     ...
     * Recursively wraps nested collections.
     *
    ...
    /**
     * Unwraps a potentially wrapped object to get the original collection.
     * Recursively unwraps nested collections.
     *
