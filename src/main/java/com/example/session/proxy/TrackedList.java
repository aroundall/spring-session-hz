...
public class TrackedList<E> implements List<E> {
    ...
    private Collection<? extends E> unwrapAll(Collection<? extends E> collection) {
        ...
        List<E> unwrapped = new ArrayList<>(collection.size());
    ...
    public boolean add(E e) {
        markChanged();
        return delegate.add(unwrapElement(e));
    }
    ...
    public boolean addAll(Collection<? extends E> c) {
        ...
        markChanged();
        return delegate.addAll(unwrapAll(c));
    }
    ...
    public boolean addAll(int index, Collection<? extends E> c) {
        ...
        markChanged();
        return delegate.addAll(index, unwrapAll(c));
    }
    ...
    public E set(int index, E element) {
        markChanged();
        return delegate.set(index, unwrapElement(element));
    }

    @Override
    public void add(int index, E element) {
        markChanged();
        delegate.add(index, unwrapElement(element));
    }
    ...
    private static class TrackedListIterator<E> implements ListIterator<E> {
        ...
        public void set(E e) {
            onChange.run();
            delegate.set((E) ChangeTrackingProxy.unwrapDelegate(e));
        }
        ...
        public void add(E e) {
            onChange.run();
            delegate.add((E) ChangeTrackingProxy.unwrapDelegate(e));
        }
    }
}
